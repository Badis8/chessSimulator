...
public class KrikorSevagMekhitarian extends BasePlayer{ 
    ChessMove[] moves = {
        ...
        new ChessMove(4, 3, 3, 2), // 2... d4 (pawn from d5 to c4)
        ...
        new ChessMove(6, 6, 3, 6) }; // 21... Qxc6+
        private int moveCounter=0;
        public KrikorSevagMekhitarian(Board board){ 
        super(board);
    }
